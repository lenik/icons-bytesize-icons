...
.\build.ps1 -Name icons-bytesize-icons -Version 1.2.3
```
...
```
<project>/.config/icons-bytesize-icons/<packaging>.build-host
$HOME/.config/icons-bytesize-icons/<packaging>.build-host
```
...
user: builder
shell: powershell
build_dir: C:/build/icons-bytesize-icons
```
